...
&emsp;プレイ動画
<iframe width="560" height="315" src="https://www.youtube.com/embed/oRfn6E21ROU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
&emsp;<img alt="操作説明_右" src="image/controllerOperation_right.png" width="700px">
...
&emsp;<img alt="multiply_1" src="image/multiply_1.png" width="1000px">    
...
&emsp;<img alt="afterRotation" src="image/afterRotation.png" width="1000px">
...
&emsp;<img alt="outlineComparison_far" src="image/outlineComparison_far.png" width="1000px">  
</font> 
...
7. 6で求めた座標を用いて、それぞれのシャドウマップにオブジェクトを描画する。
8. 6の座標を用いて、ピクセルがどのシャドウマップに含まれているか判断しシャドウマップから影をサンプリングして影を落とす。　
<br>

**クロップ行列**とは配置したライトに合わせて、視錐台の8頂点の座標を正規化スクリーン座標系において-1～1の範囲に収めるための行列。
...
**使用したランプテクスチャ**  
&emsp;<img alt="rampTexture" src="image/rampTexture.png" width="500px">  
...
浮遊時から通常時に移行する際にカメラが強制的に浮遊用から通常用に切り替わるため、処理によってはプレイヤーが思い描いた動きをできない時がある。  
